...
const birthdayV2 = () => {
  ...
  while((dia === "" || isNaN(dia) || (parseFloat(dia)<1 || parseFloat(dia)>31))){
    dia = prompt("Introduzca un dia de nacimiento valido");
  }
  while(mes === "" || isNaN(mes) || (parseFloat(mes)<1 || parseFloat(mes)>12)){
...
const write = () => {
  ...
  document.write(
    `<p>
     ...
     Naciste un feliz dia de <b>${seasonV2(dia,mes)}</b> del año <b>${anio}</b><br> 
